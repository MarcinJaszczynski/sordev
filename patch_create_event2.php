...
$content = preg_replace("/Forms\\\\Components\\\\Select::make\('contractor_id'\)/s", $newFields . "\n\n                    Forms\\Components\\Select::make('contractor_id')", $content);

file_put_contents('app/Filament/Resources/EventResource/Pages/CreateEvent.php', $content);
echo "Added back to CreateEvent.\n";
