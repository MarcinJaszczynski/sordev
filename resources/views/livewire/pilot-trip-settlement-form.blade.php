<div class="space-y-4">
    ...
    @if(!$this->editable)
        <div class="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
            {{ $showFinanceSections ? 'Rozliczenie zamknięte — tryb tylko do odczytu.' : 'Tryb tylko do odczytu.' }}
        </div>
    @endif
