...
@section('main_content')
    ...
    <div class="insurance pt_50 pb_70">
        ...
        <style>
            /* lokalne nadpisanie: pokazuj ten przycisk tylko na urządzeniach mobilnych i dodaj odstęp */
            .mobile-only-buy{ display: none !important; }
            @media (max-width: 991px) {
                .mobile-only-buy{ display: inline-flex !important; width: 100% !important; box-sizing: border-box !important; margin: 12px 0 !important; justify-content: center !important; }
            }
        </style>

        <a href="https://sklep.signal-iduna.pl/?portal_code=www.bprafa.pl&amp;ag_symbol=42505&amp;tax_number=7162508761" class="buy-button buy-button-mobile mobile-only-buy" style="z-index:3; position:relative; border-radius:50vw; padding:1.5vw 5vw; background-color:#ce0d0d; color:#fff; font-size:2vw; font-weight:600; align-items:center; text-decoration:none;" target="_blank" rel="noopener" aria-label="Wykup ubezpieczenie">
                        Wykup ubezpieczenie
                    </a>
