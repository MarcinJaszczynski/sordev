...
<script>
    // Remove auto-injected theme toggle only on BlogPosts admin pages
    document.addEventListener('DOMContentLoaded', function () {
        try {
            const path = (window.location && window.location.pathname) ? window.location.pathname : '';
            const isBlogPosts = path.startsWith('/admin/blog-posts');
            const btn = document.querySelector('[data-theme-toggle], [aria-label*="Przełącz motyw"]');
            if (btn && isBlogPosts) {
                btn.remove();
            }
        } catch (e) {
