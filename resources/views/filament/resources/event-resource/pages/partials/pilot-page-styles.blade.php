<style>
    ...
    .pilot-page-root:not([data-tab="settlement"]) .pilot-form-tab--settlement {
    ...
    .pilot-stat-card--danger .pilot-stat-hint {
        color: var(--pilot-danger-text);
        opacity: 0.85;
    }
    ...
    .pilot-stat-card--danger .pilot-stat-subvalue {
        color: var(--pilot-danger-text);
        opacity: 0.9;
    }
    ...
    .pilot-cash-flow-step--danger .pilot-cash-flow-hint {
        color: var(--pilot-danger-text);
        opacity: 0.85;
    }
    ...
    @media (max-width: 700px) {
        .pilot-settlement-grid { grid-template-columns: 1fr; }
    }

    .pilot-settlement-cell {
        background: var(--pilot-muted-card);
        border-radius: var(--pilot-control-radius);
        padding: 10px 12px;
    }
    ...
    .pilot-settlement-badge {
        ...
        font-size: var(--pilot-helper-font);
        font-weight: 600;
        background: var(--pilot-accent-bg);
        color: var(--pilot-accent-text);
        white-space: nowrap;
    }

    .pilot-settlement-badge--submitted {
        background: #FEF3C7;
        color: #92400E;
    }

    .pilot-settlement-badge--closed {
        background: var(--pilot-success-bg);
        color: var(--pilot-success-text);
    }

    .pilot-settlement-cell .text-danger {
        color: var(--pilot-danger-text);
    }
</style>
