...
>
    ...
    <div class="space-y-0 contractor-page-root">
        ...
        <div class="contractor-stat-grid">
            ...
            >
                <p class="contractor-stat-label">Imprezy</p>
                                ...
                                <tr wire:key="involvement-{{ $row['id'] }}">
                                    ...
                                    <td>
                                        <div class="contractor-table-title">
                                            @if ($row['url'])
                                                <a href="{{ $row['url'] }}" wire:navigate="false">{{ $row['title'] }}</a>
                                            @else
                                                {{ $row['title'] }}
                                            @endif
                                        </div>
                                    ...
                                    <td>
                                        @if (! empty($row['event_name']) && ($row['kind'] ?? '') !== 'event')
                                            @if ($row['event_url'])
                                                <a href="{{ $row['event_url'] }}" class="contractor-table-link" wire:navigate="false">{{ $row['event_name'] }}</a>
                                            @else
                                                {{ $row['event_name'] }}
                                            @endif
                                    ...
                                    <td class="text-right">
                                        @if ($row['url'])
                                            <a href="{{ $row['url'] }}" class="contractor-row-link" wire:navigate="false" title="Otwórz">→</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
