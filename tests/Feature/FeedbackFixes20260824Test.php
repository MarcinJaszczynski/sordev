...
class FeedbackFixes20260824Test extends TestCase
{
    ...
    public function test_vehicle_display_label_includes_manufacture_year(): void
    {
        $vehicle = Vehicle::factory()->create([
            'brand' => 'Setra',
            'model' => 'S 516',
            'manufacture_year' => 2019,
            'registration_number' => 'WW 2222B',
            'capacity' => 49,
            'crew_seats' => 2,
        ]);
        ...
        $this->assertStringContainsString('2019', $label);
        $this->assertStringContainsString('Setra', $label);
        $this->assertSame('2019', $vehicle->manufactureYearLabel());
    }
