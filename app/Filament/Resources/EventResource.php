...
class EventResource extends Resource
{
            ...
            Forms\Components\Section::make('Autokar, przewoźnik i kierowca')
                ...
                ->schema([
                    Forms\Components\Select::make('bus_id')
                        ...
                        ->helperText('Pozycja z cennika — tylko do wyceny (km, stawka). Miejsca pasażerskie sprawdzamy przy pojeździe floty poniżej.')
    ...
    {
        static::syncQtyHeadcountsFromQtyVariant($set, $get, $record);
    }

    public static function syncQtyHeadcountsFromQtyVariant(callable $set, callable $get, Event $record): void
    {
        ...
        $set('staff_count', max(0, (int) ($exactVariant->staff ?? 0)));
        $set('driver_count', max(0, (int) ($exactVariant->driver ?? 0)));
    }
    ...
    public static function getRecordSubNavigation(Page $page): array
    {
        ...
        // Dokumenty: landing = Pliki; Umowy/Historia tylko jako nested taby.
        if (Schema::hasTable('event_documents')) {
            $items[] = Pages\ManageEventDocuments::class;
        } elseif (Schema::hasTable('contracts') || Schema::hasTable('event_agreements')) {
    ...
    public static function getPages(): array
    {
        return [
            ...
            'finance-snapshots' => Pages\EventFinanceSnapshots::route('/{record}/finance/snapshots'),
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        if (! Schema::hasTable('contracts') && ! Schema::hasTable('event_agreements')) {
            ...
            return $query
                // staff/driver muszą być w select — inaczej resolve*Count na załadowanej
                // relacji zwraca 0 (null) i EditEvent wypełnia Obsługa/Kierowcy zerami.
                ->with(['qtyVariants:id,event_id,qty,gratis,staff,driver'])
                ->with($relations);
        }
