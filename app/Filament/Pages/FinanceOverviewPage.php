...
class FinanceOverviewPage extends Page
{
    ...
    public function getWorkflowSteps(): array
    {
        return [
            ...
            [
                'step' => 2,
                'title' => 'Dopasuj niedopasowane wpłaty',
                'body' => 'Przypisz ręcznie przelewy bez automatycznego dopasowania i zaksięguj je.',
            ...
            [
                'step' => 4,
                'title' => 'Opracuj stos niedopasowanych faktur',
