...
final class WordAgreementContent
{
    ...
    /**
     * @return list<array{type: 'title'|'p'|'link', text: string}>
     */
    public function standardInformationFormBlocks(): array
    {
        return [
            ...
            ['type' => 'p', 'text' => 'Dokument wygenerowany elektronicznie nie wymaga pięczęci ani podpisu'],
        ];
    }
}
